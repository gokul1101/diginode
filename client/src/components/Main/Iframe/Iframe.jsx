...
const Iframe = (props) => {
    ...
    return (
        <div id="video-overlay" className="video-overlay d-flex flex-column align-items-center justify-content-center h-100">
            <IconButton
                ...
                <div className="social-div">
                  ...
                  <div className="float-right">
                    <div id="heart-container">
                      <input type="checkbox" id="toggle" className="btn" onClick={() => setFavorite(props.currentVideo.videoId)}/>
